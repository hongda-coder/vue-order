  ...
  <div v-height>
    ...
    <div class="mianbaoxie">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item class="link">科室检测统计</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
       ...
       <div class="right left">
        ...
        <div class="table">
          <el-table ref="multipleTable" height='100%' border :data="tableData" tooltip-effect="dark" style="width: 100%" :cell-style="{padding:'15px 0'}" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="检测项目总价（元）" prop="pact_money" sortable>
            </el-table-column>
            <el-table-column label="项目总价占比" prop="pact_per" sortable>
            </el-table-column>
          </el-table>
        </div>
        <div class="page">
