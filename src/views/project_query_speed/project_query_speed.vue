  ...
  <div v-height>
    ...
    <div class="mianbaoxie">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item class="link">项目进度查询</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- 编制日期 -->
    <div class="select_time">
      <span>
        <el-form>
          <el-form-item label="项目类别" class="time">
            <div class="block">
              <el-input v-model="input" placeholder="请输入项目类别" style="margin-right: 20px;width:5rem"></el-input>
            </div>
          </el-form-item>
        </el-form>
        <el-form>
          <el-form-item label="检测项目" class="time">
            <div class="block">
        ...
        <el-form>
          <el-form-item label="科室名称" class="time">
            <div class="block">
              <el-input v-model="input" placeholder="请输入项目编号" style="margin-right: 20px;width:5rem"></el-input>
            </div>
          </el-form-item>
    ...
    <div class="select_time">
        <el-form>
          <el-form-item label="检测人员" class="time">
            <div class="block">
              <el-input v-model="input" placeholder="请搜索检测人员" style="margin-right: 20px;width:5rem"></el-input>
      ...
      <div class="right">
        <div class="table">
          <el-table ref="multipleTable" :default-sort="{prop: 'date', order: 'descending'}" height='100%' border :data="tableData" tooltip-effect="dark" style="width: 100%" :cell-style="{padding:'15px 0'}" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="name" label="项目编号" sortable>
            </el-table-column>
            <el-table-column prop="name" label="项目名称" sortable>
            </el-table-column>
            <el-table-column prop="name" label="采样时间" sortable>
            </el-table-column>
             <el-table-column prop="name" label="检测时间" sortable>
            </el-table-column>
            <el-table-column prop="name" label="出报告时间" sortable>
            </el-table-column>
          </el-table>
        </div>
        <div class="page">
