  ...
  <div v-height>
    ...
    <div class="mianbaoxie">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item class="link">年度检测统计</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
      ...
      <div class="right">
        ...
        <div class="table">
          <el-table ref="multipleTable" height='300' border :data="tableData" tooltip-effect="dark" style="width: 100%" :cell-style="{padding:'15px 0'}" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="name" label="检测月份" sortable>
            </el-table-column>
            <el-table-column prop="name" label="检测量（个）" sortable>
            </el-table-column>
            <el-table-column prop="name" label="合格量（个）" sortable>
            </el-table-column>
            <el-table-column prop="name" label="不合格量（个）" sortable>
            </el-table-column>
            <el-table-column prop="name" label="合格率" sortable>
            </el-table-column>
          </el-table>
        </div>
        <div class="page">
